      ...
      <table class="list">
        ...
        <?php foreach($categories as $category) { ?>
          <tr>
            ...
            <td><a class="action" href="<?php echo url_for('admins/category/edit.php?id=' . $category->category_id); ?>">Edit</a></td>
            <td><a class="action" href="<?php echo url_for('admins/category/delete.php?id=' . $category->category_id); ?>">Delete</a></td>
          </tr>
        <?php } ?>
      </table>
    </main>
